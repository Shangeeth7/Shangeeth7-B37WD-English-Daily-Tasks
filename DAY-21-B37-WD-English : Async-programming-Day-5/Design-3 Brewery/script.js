...
document.getElementById("click").addEventListener("click", () => {
  async function getshopdetail() {
    ...
    var find = await fetch(
      `https://api.openbrewerydb.org/breweries/search?query=${shop}`
    );
    ...
    try {
      ...
      document.getElementById(
        "card"
      ).innerHTML = `<div class="card-body text-dark">
                  <h1 class="card-title text-center text-warning"> OOPS !!!</h1><br>
                  <div class="card-text"><h4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Unable to find the brewing company.  Please Enter a valid name in search box<div>
                 </h4> </div>`;
    }
  }
  getshopdetail();
