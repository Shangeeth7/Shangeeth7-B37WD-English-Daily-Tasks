...
<div class="form-check">
  <input  class="form-check-input"  type="checkbox"  value="Rice"  id="Rice"  name="option" />
...
<div class="form-check">
    <input  class="form-check-input"  type="checkbox"  value="Chappati"  id="Chappati"  name="option" />
    <label class="form-check-label" for="Chappati"> Chappati </label>
</div>`;
form1.append(f_div6);
